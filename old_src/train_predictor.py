...
## PPI
# target_name = 'PPII'
# pos_name = 'PPII_plogP_clean'
# neg_name = 'chembl_small_molecule'
## MyD88
# target_name = 'MyD88'
# pos_name = 'MyD88'
# neg_name = 'PPII_plogP_clean'
## DYRK_siblings
# target_name = 'DYRKsib_CLK'
# pos_name = 'DYRKsib_CLK_raw'
# neg_name = 'kinase_raw'
# RdRP
# target_name = 'RdRP'
# pos_name = 'RdRP'
...
target_name = 'PPK1_5'
pos_name = 'PPK1/PPK1_5'
neg_name = 'PPK1/kinase'

def get_pos_neg(target_name = target_name, pos_name = pos_name, neg_name = neg_name):
    active_file = '../data/%s.csv' % pos_name
    negative_file = '../data/%s.csv' % neg_name
    #negative_file = '../data/PPII_plogP_clean.csv'
    #negative_file = '../data/kinase_plogP_clean.csv'
...
active_df, decoy_df = get_pos_neg()
...
#name = 'IC50_100'
# name = 'IC50_100'
# target_name = 'PPK1_%s' % name
# path = '/home/tensorflow/Desktop/work/CloudStation/now/PPK1/Classif/PaPPK1_%s.csv' % name
# df = pd.read_csv(path)
# df = df.dropna(axis=0,how='any')
# active_df = df.query('LABEL==1')
# decoy_df = df.query('LABEL==0')
# active_df = pd.concat([active_df] * math.ceil(len(decoy_df)/len(active_df)))
# active_df = active_df[0:len(decoy_df)]
# #decoy_df = decoy_df.sample(n=len(active_df), replace=False) # under_sampling
# df = pd.concat([active_df, decoy_df])
